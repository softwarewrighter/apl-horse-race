...
The slow printing terminal, where characters appeared at roughly 15 characters per second, naturally built suspense as each horse's progress was revealed. The `⎕DL 0.3` delays in this recreation are necessary because GNU APL runs far too fast on modern hardware—without them, the race would flash by instantly
